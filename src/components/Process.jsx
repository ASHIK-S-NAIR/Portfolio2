      ...
      <div className=" wrap process-container">
        <div className="process-sec">
          ...
          <p className="process-p">
            Handpicking user-focused fruitful content and resolving the
            functionalities. Structuring and wireframing to layout content.
          </p>
        ...
        <div className="process-sec">
          ...
          <p className="process-p">
            Choosing optimum colors, fonts, and icons. Setting up the layout
            concerning User Interface and User Experience for the best output.
          </p>
        ...
        <div className="process-sec">
          ...
          <p className="process-p">
            Layout implemented using structuring and styling languages.
            Interactivity is added, using programming language also utilizing
